...
# =============================================================================================
PercnetageList = [a for a in range(1, 11)]
Testtimes = 1000
...
for percnetage in PercnetageList:
    ...
    with open("20220211record.txt", 'a') as f:
    ...
    plt.savefig(f"20220211-{ percnetage }%Frequency.png")
    plt.close()
    ...
    plt.bar(XTime, YTime)
    plt.savefig(f"20220211-{ percnetage }%Time.png")
    plt.close()
